...
% pdftex "\pdfpagewidth=11in \pdfpageheight=8.5in \input CRefCard.v2.3.tex"
%
% Smaller (97%) pdf file  with horizontal offset 1.5in
% dvipdfm -l -m 0.97 -x 1.5in -o CRefCard.v2.3.pdf CRefCard.v2.3.dvi
...
%  Version 2.3 - March 2025, minor corrections

\def\versionnumber{2.3}  % Version of this reference card
\def\year{2025}
\def\month{March}
...
int main(void) \{&main routine w/o args\cr
...
% Local variables:
% compile-command: "tex CRefCard.2.3"
% End:
